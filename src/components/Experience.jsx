...
export default function Experience() {
  return (
    <section id="experience" className="scroll-mt-24 py-16 sm:scroll-mt-28 sm:py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-5 md:px-8">
        ...
        <div className="relative space-y-8">
          ...
          {experience.map((job) => (
            <Reveal key={job.id}>
              <article className="card-hover relative rounded-2xl border border-cream-200/10 bg-ink-800/60 p-5 sm:rounded-3xl sm:p-6 md:ml-10 md:p-8">
                ...
                <div className="flex flex-col gap-4 border-b border-cream-200/10 pb-6 md:flex-row md:items-start md:justify-between">
                  <div>
                    ...
                    <h3 className="mt-2 font-display text-2xl text-cream-50 sm:text-3xl">{job.role}</h3>
